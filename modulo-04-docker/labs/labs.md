...
## Lab 0: Pré-requisitos e Validação (10 min)

### Objetivo
Garantir que ambiente está 100% pronto antes de iniciar.

### Passo 0.1 - Verificar Docker
```bash
# Testar Docker
docker --version
docker info
...
**Só prossiga se `docker ps` funcionar sem sudo.**

---

### Passo 0.2 - Verificar projeto TaskManager
```bash
# Navegar para projeto
cd ~/devops-bootcamp/taskmanager-starter

# Verificar arquivos essenciais
ls -la | grep -E "(app.py|config.py|requirements.txt)"
```
...
### Passo 0.3 - Verificar Python/venv
```bash
# Verificar Python
python3 --version
...
Antes de prosseguir para Lab 1, confirme:

- [ ] `docker ps` funciona sem sudo
- [ ] Projeto em `~/devops-bootcamp/taskmanager-starter/`
- [ ] TaskManager roda com `python app.py`
- [ ] Curl no /health retorna JSON

**Se todos itens OK, prossiga para Lab 1.**
